...
// 設定 CORS
var allowOrigins = Environment.GetEnvironmentVariable("Allow_Origins");
...
var mainConnStr  = $"server={mainServer};database={mainDb};user={mainUser};password={mainPassword};port=3306;SslMode=Required;";
